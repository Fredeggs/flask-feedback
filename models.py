...
class User(db.Model):
    ...
    def __repr__(self):
        u = self
        return f"<User username={u.username} email={u.email} first_name={u.first_name} last_name={u.last_name}>"
...
class Feedback(db.Model):
    ...
    # user = db.relationship("User", backref="users", passive_deletes=True)
